...
y=section('4. Make it yours','The default is a black Matrix-style theme, percentage left, larger text, an unlocked Windows dock, and a one-hour dock activity interval. Adjust theme, text size and launch-at-login in Settings. Closing the dashboard keeps the native meters running; Quit ends the app.',y)
